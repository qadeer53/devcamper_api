...
exports.getCourse = asyncHandler(async (req, res, next) => {
        ...
        if (!course) {
            return next(new ErrorResponse(`course not found of id ${req.params.id}`, 404))
        }
...
exports.addCourse = asyncHandler(async (req, res, next) => {
    ...
    req.body.bootcamp = req.params.bootcampId
      req.body.user = req.user.id;
        ...
        if (!bootcamp) {
            return next(new ErrorResponse(`Bootcamp not found of id ${req.params.bootcampId}`, 404))
    }
